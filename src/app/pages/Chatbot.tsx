  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Chatbot IA ESG</h1>
          <p className="text-gray-600">Assistant alimente par le backend local RAG de cette plateforme.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-6 text-white">
              ...
              <p className="text-sm text-emerald-100 mb-4">
                Propulse par le backend Flask local et le contrat RAG de cette plateforme
              </p>
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white/20 rounded-lg p-3">
                  <p className="text-2xl font-bold">500+</p>
